...
@app.route("/mensagens/<int:id_mensagem>/usuario/<int:id_usuario>", methods=["DELETE"])
def apagar_mensagem(id_mensagem, id_usuario):
    resultado = chat.apagar_mensagem(id_mensagem,
                                     id_usuario)
